...
<body>
    ...
    <div class="container">
        <h1 style="color:#5d4037; margin-bottom:15px;">ARCHAEOTECH</h1>
        <form action="analiz.php" method="GET">
            <h3 style="margin-bottom:10px; font-size:1rem;">TARİHİ YER SEÇİNİZ</h3>
            <select name="q" required>
                ...
                <option value="Ayasofya">Ayasofya</option>
            </select>
