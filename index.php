...
<head>
    ...
    <title>ArchaeoTech | Türkiye Rehberi</title>
...
<body class="home-bg">
    <div class="overlay"></div> <div class="main-wrapper">
        ...
        <div class="search-card">
            <h3>🔍 Hangi Tarihi Eseri Merak Ediyorsunuz?</h3>
            <form action="analiz.php" method="post">
                <input type="text" name="eser_adi" placeholder="Örn: Sümela Manastırı, Efes..." required>
