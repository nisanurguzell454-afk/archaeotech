...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        input { width: 100%; padding: 15px; border-radius: 10px; border: 1px solid #ddd; margin-bottom: 20px; outline: none; font-size: 1rem; text-align: center;}
        ...
        footer { margin-top: 50px; color: #fff; font-size: 0.8rem; text-shadow: 1px 1px 5px #000;}
    </style>
</head>
<body>
    ...
    <div class="main-wrapper">
        <header>
            <h1>ARCHAEOTECH</h1>
            <p style="color:#eee; margin-bottom:20px;">Türkiye'nin Mirasını Keşfet</p>
        </header>
        <div class="card">
