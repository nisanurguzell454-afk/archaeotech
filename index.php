...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        h1 { color: #5d4037; letter-spacing: 3px; margin-bottom: 20px; }
    </style>
</head>
<body>
    ...
    <div class="container">
        <h1>ARCHAEOTECH</h1>
        <p style="margin-bottom:20px; font-size:14px; color:#666;">Türkiye'nin Tarihi Mirasını Keşfedin</p>
        ...
        <p style="margin-top:20px; font-size:12px; color:#999;">Nisa Nur Güzel | 2026</p>
    </div>
</body>
</html>
